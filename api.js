...
MagicKingdom.GetWaitTimes(function(err, data) {
    ...
    htmlPage="<html><style>.toplink{float: left;font-size:20px; margin: 20px 0px 0px 5px;}a{width: 120px;margin: 23px 0px 0px 5px; font-size:15px;float:left;text-decoration: none; color:white; font-family: Roboto, Arial, Helvetica, sans-serif;}body{float: left;font-family: Roboto, Arial, Helvetica, sans-serif; color:white;} .topmenu{font-size:30px; -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; background-color:#6632ec; height:60px; width: 400px;margin-bottom:1px;position:fixed;} .red {padding-left: 8px !important; width: 22px !important; background-color:#d31344 !important;} .yellow {padding-left: 8px !important; width: 22px !important; color:white !important;background-color:#fecc0f !important;}ul {list-style:none !important;font-size:14px;width:400px;Padding :0px; margin:61px 0px 0px 0px;color:gray;font-family: Helvetica Regular, Arial, Helvetica, sans-serif;}span{-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;float:left;padding-top:7px; padding-left:11px;background-color:#9bd72e;margin-left:7px;height:23px;width:19px;margin-top: 4px;color:white;}p{float:left;width:350px;margin: 13px 0px 10px 5px;}li{ -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px;margin-bottom:1px !important;background-color:white;height:40px;margin:0;border:1px;padding:2px;border-bottom: 1px solid #f1f1f1;}body{margin:0;padding:0;border:0;}</style><body>";
